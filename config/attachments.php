...
return [
    ...
    'max_provider_message_bytes' => (int) env('INBOUND_EMAIL_MAX_PROVIDER_MESSAGE_BYTES', 40 * 1024 * 1024),
    'max_mime_depth' => (int) env('INBOUND_EMAIL_MAX_MIME_DEPTH', 32),
    'max_mime_parts' => (int) env('INBOUND_EMAIL_MAX_MIME_PARTS', 1000),
